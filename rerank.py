...
if __name__ == '__main__':
    ...
    predictions = []
    assert len(rte_predictions) == len(aggregated_labels) == len(predicted_evidences) == len(
        ids), '{}, {}, {}, {}'.format(len(rte_predictions), len(aggregated_labels), len(predicted_evidences), len(ids))
