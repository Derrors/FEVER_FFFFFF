...
if __name__ == '__main__':
    ...
    if not (os.path.exists(config_ir['train_output_file']) and os.path.exists(config_ir['dev_output_file'])):
        ir(config['ir'])                    # python get_evidence.py
    else:
    ...
    if not(os.path.exists(
        ...
        convert(conf_convert)               # python convert.py
    else:
    ...
    if not os.path.isdir(conf_train_rte['save_dir']):
        train_rte(conf_train_rte)           # python ../jack/bin/jack-train.py
    else:
